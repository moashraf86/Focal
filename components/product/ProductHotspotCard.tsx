        ...
        >
          ...
          <div className="space-y-1">
            <a
              ...
              className="text-sm font-light font-barlow"
            >
              {product.name}
            </a>
            <div className="flex items-center space-x-2 font-barlow">
              ...
              {hasOptions ? (
                <button
                  className="text-sm font-light underline underline-offset-2 text-primary/50 hover:text-primary"
